...
static const unsigned int TARGET_SPACING = 150;
inline int64_t FutureDrift(int64_t nTime) { return nTime + 150; }
...
public:
    ...
    void SetStakeModifier(bool fGeneratedStakeModifier)
    {
...
static CMainSignals g_main_signals;
